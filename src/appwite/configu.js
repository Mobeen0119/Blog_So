        ...
        try {
            const post = await this.databases.createDocument(
                ...
                ID.unique(), {
                    ...
                    status,
                    userid,
                    // REMOVE THIS: createdAt: new Date().toISOString(), // Appwrite adds this automatically
                });
        ...
        try {
            const post = await this.databases.updateDocument(
                ...
                postId, {
                    ...
                    images,
                    userid,
                    // Don't update status - keep as is
                });
            return { success: true, data: post };
        } catch (err) {
    ...
    async deletePost(slug) {
        try {
            await this.databases.deleteDocument(
                conf.appwriteDatabaseId, // Changed
                conf.appwriteCollectionId, // Changed
                slug);
            return true;
        } catch (err) {
